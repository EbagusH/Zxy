            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="px-6 pb-8">
                    ...
                    <div class="prose prose-lg max-w-none">
                        <div class="text-gray-700 leading-relaxed whitespace-pre-line">{{ $dayasos->isi }}</div>
                    </div>
                    @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500">Informasi tentang Bidang Dayasos sedang dalam proses penyusunan.</p>
                    </div>
                    @endif
                </div>
            </div>
