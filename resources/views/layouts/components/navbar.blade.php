                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="relative"
                        ...
                        <button class="flex items-center rounded-md px-4 py-3 text-sm font-medium transition-all duration-200 backdrop-blur-sm"
                            :class="scrolled ? 
                                    '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos', 'profil.resos']) ? 'bg-blue-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}' : 
                                    '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos', 'profil.resos']) ? 'bg-white/20 text-white shadow-lg border border-white/30' : 'text-white/90 hover:bg-white/10 hover:text-white' }}'">
                            <span>Profil</span>
                        ...
                        <div x-show="profilOpen"
                            ...
                            <div class="py-2">
                                ...
                                <a href="{{ route('profil.dayasos') }}"
                                    class="flex items-center px-4 py-3 text-sm transition-colors duration-200
                                           {{ request()->routeIs('profil.dayasos') ? 'bg-blue-50 text-blue-600 border-r-3 border-blue-600 font-medium' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
                                    <i class="fas fa-bullseye mr-3 text-gray-400 w-4"></i>
                                    Bidang Dayasos
                                </a>
                                <a href="{{ route('profil.resos') }}"
                                    class="flex items-center px-4 py-3 text-sm transition-colors duration-200
                                           {{ request()->routeIs('profil.resos') ? 'bg-blue-50 text-blue-600 border-r-3 border-blue-600 font-medium' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
                                    <i class="fas fa-bullseye mr-3 text-gray-400 w-4"></i>
                                    Bidang Resos
                                </a>
                            </div>
        ...
        <div class="space-y-1 px-2 pb-3 pt-2 shadow-lg border-t transition-all duration-300"
            ...
            <div class="relative">
                <button @click="mobileProfilOpen = !mobileProfilOpen"
                    ...
                    :class="scrolled ? 
                        '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos', 'profil.resos']) ? 'bg-blue-500 text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}' : 
                        '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos', 'profil.resos']) ? 'bg-white/20 text-white border border-white/30' : 'text-white/90 hover:bg-white/10 hover:text-white' }}'">
                    <span>Profil</span>
                ...
                <div x-show="mobileProfilOpen"
                    ...
                    <a href="{{ route('profil.linjamsos') }}"
                        class="block px-3 py-2 text-sm rounded-md transition-all duration-200"
                        :class="scrolled ? 
                            '{{ request()->routeIs('profil.linjamsos') ? 'bg-blue-400 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}' : 
                            '{{ request()->routeIs('profil.linjamsos') ? 'bg-white/20 text-white border border-white/30' : 'text-white/80 hover:bg-white/10 hover:text-white' }}'">
                        <i class="fas fa-bullseye mr-2" :class="scrolled ? 'text-gray-400' : 'text-white/60'"></i>
                        Bidang Linjamsos
                    </a>
                    <a href="{{ route('profil.dayasos') }}"
                        class="block px-3 py-2 text-sm rounded-md transition-all duration-200"
                        :class="scrolled ? 
                            '{{ request()->routeIs('profil.dayasos') ? 'bg-blue-400 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}' : 
                            '{{ request()->routeIs('profil.dayasos') ? 'bg-white/20 text-white border border-white/30' : 'text-white/80 hover:bg-white/10 hover:text-white' }}'">
                        <i class="fas fa-bullseye mr-2" :class="scrolled ? 'text-gray-400' : 'text-white/60'"></i>
                        Bidang Dayasos
                    </a>
                    <a href="{{ route('profil.resos') }}"
                        class="block px-3 py-2 text-sm rounded-md transition-all duration-200"
                        :class="scrolled ? 
                            '{{ request()->routeIs('profil.resos') ? 'bg-blue-400 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}' : 
                            '{{ request()->routeIs('profil.resos') ? 'bg-white/20 text-white border border-white/30' : 'text-white/80 hover:bg-white/10 hover:text-white' }}'">
                        <i class="fas fa-bullseye mr-2" :class="scrolled ? 'text-gray-400' : 'text-white/60'"></i>
                        Bidang Resos
                    </a>
                </div>
