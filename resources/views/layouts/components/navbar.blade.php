                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="relative"
                        ...
                        <button class="flex items-center rounded-md px-4 py-3 text-sm font-medium transition-all duration-200 backdrop-blur-sm"
                            :class="scrolled ? 
                                    '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos']) ? 'bg-blue-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}' : 
                                    '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos']) ? 'bg-white/20 text-white shadow-lg border border-white/30' : 'text-white/90 hover:bg-white/10 hover:text-white' }}'">
                            <span>Profil</span>
        ...
        <div class="space-y-1 px-2 pb-3 pt-2 shadow-lg border-t transition-all duration-300"
            ...
            <div class="relative">
                <button @click="mobileProfilOpen = !mobileProfilOpen"
                    ...
                    :class="scrolled ? 
                        '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos']) ? 'bg-blue-500 text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}' : 
                        '{{ request()->routeIs(['profil.sambutan', 'profil.struktur', 'profil.pegawai', 'profil.visi-misi', 'profil.linjamsos', 'profil.dayasos']) ? 'bg-white/20 text-white border border-white/30' : 'text-white/90 hover:bg-white/10 hover:text-white' }}'">
                    <span>Profil</span>
