...
@section('title', 'Bidang Linjamsos - Dinas Sosial Kabupaten Majalengka')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Bidang Linjamsos</h1>
                    <p class="text-gray-600 mt-2">Kelola informasi Bidang Linjamsos</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            <form action="{{ route('dashboard.profil.linjamsos.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <h2 class="text-xl font-semibold text-gray-800 border-b border-gray-200 pb-2">
                                Informasi Bidang Linjamsos
                            </h2>

                            <!-- Foto Upload with Drag & Drop -->
                            <div>
                                <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">
                                    Foto Bidang Linjamsos
                                </label>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Masukkan deskripsi, tugas pokok, dan fungsi Bidang Linjamsos...">{{ old('isi', $linjamsos->isi ?? '') }}</textarea>
                                @error('isi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg border min-h-32">
                                    ...
                                    <p class="text-gray-700 whitespace-pre-line">{{ $linjamsos->isi }}</p>
                                    @else
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-lg">
                    <div class="flex justify-between items-center">
                        <div class="text-sm text-gray-500">
                            ...
                            @if($linjamsos && $linjamsos->updated_at)
                            {{ $linjamsos->updated_at->format('d F Y, H:i') }} WIB
                            @else
