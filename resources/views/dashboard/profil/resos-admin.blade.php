...
@section('title', 'Bidang Resos - Dinas Sosial Kabupaten Majalengka')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Bidang Resos</h1>
                    <p class="text-gray-600 mt-2">Kelola informasi Bidang Resos</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            <form action="{{ route('dashboard.profil.resos.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Masukkan deskripsi, tugas pokok, dan fungsi Bidang Resos...">{{ old('isi', $resos->isi ?? '') }}</textarea>
                                @error('isi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg border min-h-32">
                                    @if($resos && $resos->isi)
                                    <p class="text-gray-700 whitespace-pre-line">{{ $resos->isi }}</p>
                                    @else
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-lg">
                    <div class="flex justify-between items-center">
                        <div class="text-sm text-gray-500">
                            ...
                            @if($resos && $resos->updated_at)
                            {{ $resos->updated_at->format('d F Y, H:i') }} WIB
                            @else
