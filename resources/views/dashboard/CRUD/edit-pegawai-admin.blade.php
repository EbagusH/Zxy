...
@section('title', 'Edit Pegawai - Dinas Sosial Kabupaten Majalengka')
        ...
        <div class="flex flex-col space-y-3 md:flex-row md:justify-between md:items-center md:space-y-0">
            <div>
                ...
                <p class="text-sm md:text-base text-gray-600">
                    Edit data pegawai Dinas Sosial Kabupaten Majalengka
                </p>
            </div>
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Perbarui informasi dasar pegawai
                </p>
            </div>

            <form action="{{ route('dashboard.profil.pegawai.update', $pegawai->id) }}"
                method="POST"
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative mb-4">
                            <div id="photo-preview" class="w-32 h-32 rounded-full border-4 border-gray-200 overflow-hidden bg-gray-100">
                                @if($pegawai->foto)
                                <img src="{{ asset('storage/' . $pegawai->foto) }}" alt="Foto Pegawai" class="w-full h-full object-cover" id="preview-img">
                                @else
                ...
                <div class="mb-6">
                    ...
                    <select id="jabatan"
                        ...
                        <option value="Kepala Dinas" {{ old('jabatan', $pegawai->jabatan) == 'Kepala Dinas' ? 'selected' : '' }}>Kepala Dinas</option>
                        <option value="Sekretaris" {{ old('jabatan', $pegawai->jabatan) == 'Sekretaris' ? 'selected' : '' }}>Sekretaris</option>
                        <option value="Kabid" {{ old('jabatan', $pegawai->jabatan) == 'Kabid' ? 'selected' : '' }}>Kabid</option>
                        <option value="Kasubag" {{ old('jabatan', $pegawai->jabatan) == 'Kasubag' ? 'selected' : '' }}>Kasubag</option>
                        <option value="Kasi" {{ old('jabatan', $pegawai->jabatan) == 'Kasi' ? 'selected' : '' }}>Kasi</option>
