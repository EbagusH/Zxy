...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Pengajuan Layanan Terbaru</h2>
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody>
                        <tr class="border-b">
                            <td class="py-3">Budi</td>
                            <td class="py-3">Bantuan Sosial</td>
                            <td class="py-3"><span class="text-yellow-600 font-medium">Menunggu</span></td>
                        </tr>
                        <tr>
                            <td class="py-3">Siti</td>
                            <td class="py-3">Konsultasi</td>
                            <td class="py-3"><span class="text-green-600 font-medium">Diterima</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
